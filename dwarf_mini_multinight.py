...
def main():
    ...
    for key in sorted(groups):
        ...
        if not os.path.exists(cal_seq + ".fit"):
            raise RuntimeError(f"Expected calibrated sequence was not created: {cal_seq}.fit")
